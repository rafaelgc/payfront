...
// This component is responsible for checking if there's an authentication token in the local storage.
// If there is, it is stored in the global state. This allow us:
...
export const Authentication = ({ children, useHeap = true }: AuthenticationProps) => {
